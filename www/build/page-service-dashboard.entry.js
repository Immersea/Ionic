...
const pageServiceDashboardCss = "page-service-dashboard{}";

const PageServiceDashboard = class {
    constructor(hostRef) {
    ...
    render() {
        return this.serviceCenter
            ? [
                h("ion-header", null, h("app-navbar", { tag: 'dashboard', text: 'Dashboard', color: 'servicecenter' })),
                h("ion-content", null, "Coming soon!"),
            ]
            : undefined;
    }
};
PageServiceDashboard.style = pageServiceDashboardCss;

export { PageServiceDashboard as page_service_dashboard };

//# sourceMappingURL=page-service-dashboard.entry.js.map