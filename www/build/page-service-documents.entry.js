...
const pageServiceDocumentsCss = "page-service-documents{}";

const PageServiceDocuments = class {
    constructor(hostRef) {
    ...
    render() {
        return this.serviceCenter
            ? [
                h("ion-header", null, h("app-navbar", { tag: 'documents', text: 'Documents', color: 'documents' })),
                h("ion-content", null, "Coming soon!"),
            ]
            : undefined;
    }
};
PageServiceDocuments.style = pageServiceDocumentsCss;

export { PageServiceDocuments as page_service_documents };

//# sourceMappingURL=page-service-documents.entry.js.map