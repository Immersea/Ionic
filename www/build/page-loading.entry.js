...
const PageLoading = class {
    ...
    render() {
        return [
            h("div", { key: '574e4dbfb568a6e30ae58750fb97fb28ce31dbf9' }, false //old logo
                ? [
                ...
                : undefined, h("ion-title", { key: '2a8b7c52ca693684599cd01ee5785620de45d747', class: 'loading-title ion-text-center', size: 'large' }, Environment.getAppTitle()), h("ion-title", { key: '33c4e13b9c3570d3c41bc87c0ca178086eda71bc', class: 'loading-subtitle ion-text-center', size: 'small' }, Environment.getAppSubTitle()), h("img", { key: '286a9890a1b8606691deba0312f2a61f322a81cc', src: "assets/images/" + Environment.getAppLogo(), class: 'loading-svg', alt: 'Loading...', style: { visibility: "visible" } }), this.network ? (h("ion-spinner", { class: 'loading-spinner', name: 'crescent' })) : ([
