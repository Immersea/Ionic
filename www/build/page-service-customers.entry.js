...
const pageServiceCustomersCss = "page-service-customers{}";

const PageServiceCustomers = class {
    constructor(hostRef) {
...
PageServiceCustomers.style = pageServiceCustomersCss;

export { PageServiceCustomers as page_service_customers };

//# sourceMappingURL=page-service-customers.entry.js.map