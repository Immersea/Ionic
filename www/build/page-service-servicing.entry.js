...
const pageServiceServicingCss = "page-service-servicing{}";

const PageServiceServicing = class {
    constructor(hostRef) {
    ...
    render() {
        return this.serviceCenter
            ? [
                h("ion-header", null, h("app-navbar", { tag: 'servicing', text: 'Servicing', color: 'servicecenter' })),
                h("ion-content", null, "Coming soon!"),
            ]
            : undefined;
    }
};
PageServiceServicing.style = pageServiceServicingCss;

export { PageServiceServicing as page_service_servicing };

//# sourceMappingURL=page-service-servicing.entry.js.map