...
class UserPlan {
    constructor(data) {
        ...
        if (data && data.planOfActions && data.planOfActions.length > 0) {
            ...
            this.planOfActions = lodash.exports.orderBy(this.planOfActions, "dueDate");
        }
    }
}
class PlanOfAction {
...
export { PlanOfAction as P, UserPlans as U, UserPlan as a, ProductLines as b };

//# sourceMappingURL=user-plans-3e6cb6aa.js.map