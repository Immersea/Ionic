...
import { a as attachComponent, d as detachComponent } from './framework-delegate-779ab78c.js';
import { s as shallowEqualStringMap, h as hasLazyBuild } from './helpers-ff3eb5b3.js';
import { c as createLockController } from './lock-controller-6e56849c.js';
import { t as transition } from './index-222db2aa.js';
...
const RouterOutlet = class {
    ...
    async connectedCallback() {
        ...
        this.gesture = (await import('./swipe-back-3d20fc63.js')).createSwipeBackGesture(this.el, () => !this.gestureOrAnimationInProgress && !!this.swipeHandler && this.swipeHandler.canStart(), () => onStart(), (step) => { var _a; return (_a = this.ani) === null || _a === void 0 ? void 0 : _a.progressStep(step); }, (shouldComplete, step, dur) => {
            if (this.ani) {
                this.ani.onFinish(() => {
                    this.gestureOrAnimationInProgress = false;
                    if (this.swipeHandler) {
