...
import { T as TranslationService, R as RouterService, x as AuthService, B as SystemService, aI as EmailAuthProvider, aJ as GoogleAuthProvider, aK as FacebookAuthProvider } from './utils-ced1e260.js';
...
const PageLostpsw = class {
    ...
    render() {
        return [
            h("app-navbar", { key: '2df063c32f6921319ae472628ece5899ce1e197c', color: Environment.getAppColor(), tag: 'forgot-psw', text: 'Forgot Password', "back-button": true }),
            h("ion-content", { key: '0555598fc354bb0291d31bea7d309a05eecb7fbf', scrollEvents: true, onIonScroll: (ev) => (this.scrollTop = ev.detail.scrollTop) }, Environment.isUdive() || Environment.isDecoplanner() ? (h("app-banner", { scrollTopValue: this.scrollTop, heightPx: 250, link: 'assets/images/friendship2SM.jpg' })) : undefined, h("ion-grid", { key: '9f57e30cb40be36209410fdad03c823d98749a78' }, h("ion-row", { key: '6e5a7f11a7f4979b8ff7d40c4e9a9147ffc29927' }, h("ion-col", { key: 'cd3ce85ee204fa394ce8d403b84cd36f5f592b44' }, h("app-form-item", { key: 'd69d29ddbcd2f7f9d606f770f2f02580a66351c6', "label-tag": 'email', "label-text": 'Email', name: 'emailpsw', "input-type": 'email', onFormItemChanged: (ev) => this.inputHandler(ev), validator: ["required", "email"] }), h("ion-button", { key: '30b86a9b18f9550b8a5447a683cb46f878b3e594', "margin-top": true, expand: 'block', disabled: !this.emailpsw.valid, onClick: () => this.checkEmail() }, h("my-transl", { key: '6d3aed94ac7b389dca529748400ae41a13a66310', tag: 'login-resetpsw', text: 'Reset my password' })))))),
        ];
    }
};
