...
const AppMapPopup = class {
    ...
    render() {
        return (h(Host, { key: '5a249f3c4ffdeba3416f001a687b44189b807237' }, this.propObject.item.coverURL ? (h("div", { class: "cover", style: this.propObject.item.coverURL
                ? {
                ...
                : "./assets/images/avatar.png" }))) : undefined, h("h2", { key: '314446481495662e0333e35fcc2df46c8fc76f5a', class: "center" }, this.propObject.item.displayName), h("div", { key: 'c94ff6fd00759ca58f7b937b1747c321cd02def4', class: "center" }, h("ion-button", { key: 'c922e93764f5a65f4b43f2745e7d4374bd414b3c', expand: "full", fill: "outline", color: "dark", onClick: () => this.openModal() }, h("my-transl", { key: '387cf3f5b3b4e8071cbc7c09dece1a8becb8c425', tag: "details", text: "Details" }))), this.propObject.collection == DIVESITESCOLLECTION ? (h("div", { class: "center" }, h("ion-button", { expand: "full", fill: "outline", color: "secondary", onClick: () => this.planDive() }, h("my-transl", { tag: "plan-dive", text: "Plan a Dive" })))) : undefined, !Environment.isTrasteel() &&
            this.userRoles &&
            ...
            : undefined, h("div", { key: '695bc02e107631781f8839fa8bdc9f7721f17fb8', class: "margin" })));
    }
