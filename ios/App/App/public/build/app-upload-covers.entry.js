    ...
    async uploadImage(blob, type) {
        switch (this.item.collection) {
            ...
            case SYSTEMCOLLECTION:
                return await StorageService.updatePhotoURL(SERVICECENTERSCOLLECTION, type, this.item.id, blob);
        }
    }
    render() {
        return [
...
AppUploadCovers.style = appUploadCoversCss;

export { AppUploadCovers as app_upload_covers };

//# sourceMappingURL=app-upload-covers.entry.js.map