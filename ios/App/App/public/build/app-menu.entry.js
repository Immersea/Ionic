...
import { A as ADMINROUTE, o as DIVECOMMUNITIESCOLLECTION, p as DiveCommunitiesService, c as DIVECENTERSSCOLLECTION, i as DivingCentersService, m as DIVESCHOOLSSCOLLECTION, n as DivingSchoolsService, k as SERVICECENTERSCOLLECTION, l as ServiceCentersService, U as UserService, E as UDiveFilterService, C as CUSTOMERSCOLLECTION, F as TrasteelFilterService, P as PROJECTSCOLLECTION, s as DATASHEETSCOLLECTION, t as SHAPESCOLLECTION, R as RouterService, T as TranslationService } from './utils-5cd4c7bb.js';
import { E as Environment } from './env-0a7fccce.js';
import './index-be90eba5.js';
import { m as menuController } from './index-f47409f3.js';
import { l as lodash } from './lodash-68d560b6.js';
import { B as Browser } from './index-698d18ee.js';
                ...
                listButtons: [
                    {
                        ...
                        externalUrl: "https://virtual-tours-imrs.web.app/trasteel/index.htm",
                        iconType: "ionicon",
...
const AppMenu = class {
    ...
    render() {
        return (h("ion-split-pane", { key: 'c7e792a78d538f0584a8141d68038151643d27e3', "content-id": "menu-content", when: this.showMenu }, h("ion-menu", { key: '9b50ff77f80b2236d2cdc2f81a2184b6870cf5a6', "content-id": "menu-content", menuId: "user" }, h("ion-header", { key: '036981dfe4aa066d4a8dc00ca50f942d53702264' }, h("ion-toolbar", { key: '928d55046e41d9e723a58cafd76a88b526c30a56', color: this.headerColor }, h("img", { key: '106dd0d852eee07a1c8358dafdfd8394eb54e84e', slot: "start", class: "logo", src: "./assets/images/" + Environment.getAppLogo() }), h("ion-title", { key: '46fa1bc73aec8e1689c3e2cc59c45c0463a78a16' }, Environment.getAppTitle()), Environment.getAppSubTitle() && !isPlatform("ios") ? (h("ion-title", { size: "small" }, Environment.getAppSubTitle())) : undefined)), h("ion-content", { key: '8389b4797cab7f2f3651f4554abf0514dd0c8020', forceOverscroll: false }, this.userRoles ? (h("app-user-cover", { showUserDetails: false, class: "cover" })) : undefined, this.appMenu.map((list) => (h("ion-list", null, h("ion-list-header", null, h("my-transl", { tag: list.listTitle.tag, text: list.listTitle.text, isLabel: true })), list.listButtons.map((p) => !p.adminOnly ||
            (p.adminOnly && UserService.userRoles.isAdmin()) ? (h("ion-menu-toggle", { autoHide: false }, h("ion-item", { button: true, onClick: () => this.itemSelect(p), detail: false, color: this.selectedMenu == p.url ? this.headerColor : "" }, p.avatar ? (h("ion-avatar", { slot: "start" }, h("img", { src: p.avatar }))) : p.iconType && p.iconType !== "ionicon" ? (p.iconType == "custom" ? (h("ion-icon", { slot: "start", src: p.icon })) : (h("ion-icon", { slot: "start", class: p.iconType == "mapicon"
                ...
                : p.iconType == "udiveicon"
                    ? "udive-icon " + p.icon
                    : undefined }))) : (h("ion-icon", { slot: "start", name: p.icon })), h("ion-label", null, h("my-transl", { tag: p.tag ? p.tag : null, text: p.text }))))) : undefined))))), h("ion-footer", { key: 'eb6427c8f6ced1efe91308686b7ef8531af07f68' }, h("ion-title", { key: 'ac1054ef7044f952fa4d15b4212bc1e340fee924', size: "small" }, "version: " + Environment.getAppVersion()))), h("ion-menu", { key: '954fb244b8e7739f1cad9a26bb6fd4352d4e1b04', "content-id": "menu-content", menuId: "admin" }, this.adminMenu
            ? [
            ...
            : undefined), h("ion-router-outlet", { key: '70add1392ba82a0a6f98d5f85ec57b5c7cbd870c', animated: true, id: "menu-content" })));
    }
};
