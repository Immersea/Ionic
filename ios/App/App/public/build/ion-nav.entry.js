import { r as registerInstance, l as createEvent, f as Build, h, k as getElement } from './index-d515af00.js';
import { g as getTimeGivenProgression } from './cubic-bezier-acda64df.js';
import { j as assert, s as shallowEqualStringMap } from './helpers-ff3eb5b3.js';
import { p as printIonWarning } from './index-93ceac82.js';
import { l as lifecycle, L as LIFECYCLE_WILL_UNLOAD, a as LIFECYCLE_WILL_LEAVE, b as LIFECYCLE_DID_LEAVE, t as transition, s as setPageHidden } from './index-222db2aa.js';
import { g as getIonMode, c as config } from './ionic-global-c07767bf.js';
import { a as attachComponent } from './framework-delegate-779ab78c.js';
...
const Nav = class {
    ...
    async componentDidLoad() {
        ...
        this.didLoad = true;
        this.rootChanged();
        this.gesture = (await import('./swipe-back-3d20fc63.js')).createSwipeBackGesture(this.el, this.canStart.bind(this), this.onStart.bind(this), this.onMove.bind(this), this.onEnd.bind(this));
