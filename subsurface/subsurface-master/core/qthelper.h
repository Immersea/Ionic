...
// Stub libxslt types for WebAssembly build
using xsltStylesheetPtr = void*;
#else
...
#ifdef __EMSCRIPTEN__
// Stubs for Qt types when building WebAssembly
#include <vector>
// Forward-declare divecomputer to satisfy references in function signatures
struct divecomputer;
class QDateTime { public: QDateTime() = default; };
class gettextFromC { public: static const char* tr(const char* text) { return text; } };
