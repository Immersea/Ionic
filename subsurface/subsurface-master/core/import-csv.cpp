...
// Include con virgolette quando compili in WebAssembly
#include "libdivecomputer/parser.h"

// Stub per XSLT (usato in parse_csv_file)
int xsltMaxDepth = 0;
#if defined(LIBXSLT_VERSION) && LIBXSLT_VERSION > 10126
int xsltMaxVars = 0;
#endif

// Stub per la costante usata a fini diagnostici
#define SUBSURFACE_SOURCE ""

// Stub per la macro di traduzione Qt
